				...
				<form onSubmit={submit} className="mt-2">
					...
					<div className="flex w-full gap-3">
						...
						<button
							...
							type="button"
							className="flex items-center gap-2 rounded-md border border-transparent bg-gray-950 px-3 text-sm font-medium text-slate-50 hover:bg-gray-800 dark:bg-slate-50 dark:text-gray-950 dark:hover:bg-slate-200"
						>
